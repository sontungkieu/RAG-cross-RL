...
\begin{itemize}
  ...
  \item Retrieve from \textbf{multiple sources}, especially task instructions, stage descriptions, and demonstration clips, with manual text treated only as an optional extension.
